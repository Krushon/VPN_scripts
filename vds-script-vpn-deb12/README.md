# vds-script-vpn-deb12
(bash scripts for debian 12)<br>
<br>
...
<br><br>
Все скрипты настроены на debian 12 и доступом по root через ssh с ключом.<br>
<br>
...
1 - Обновление ОС. Выполняется проверка версии дистрибутива. Если версия 10, то обновляется до 11. Если 11, то просто обновляется.<br>
2 - Установка ПО: openvpn, asterisk, mc, screenfetch, chrony, fail2ban, nftables.<br>
