...
###
wget https://raw.githubusercontent.com/Krushon/vds-script-vpn-deb10/master/1_script-upgrade.sh
wget https://raw.githubusercontent.com/Krushon/vds-script-vpn-deb10/master/2_script-install.sh
wget https://raw.githubusercontent.com/Krushon/vds-script-vpn-deb10/master/3_script-cert.sh
wget https://raw.githubusercontent.com/Krushon/vds-script-vpn-deb10/master/script-delete.sh
